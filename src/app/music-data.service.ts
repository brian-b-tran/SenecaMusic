...
export class MusicDataService {
  ...
  addToFavourites(id : String): Observable<[String]> {
    console.log('adding to favourites from api..');
    let body = {
      id: id
    }
    return this.http.put<[String]>(`${environment.userAPIBase}/favourites/${id}`, body);
  }
  
  removeFromFavourites(id: String): Observable<any> {
    console.log('deleting from favourites from api..');
  ...
  getFavourites(): Observable<any> {
    console.log('getting favourites from api..');
